...
public class DTLSOrg {
     ...
     */
    void doServerSide(DatagramSocket socket)
            throws Exception {
        ...
        // handshaking
        SocketAddress clientSocketAddr = handshake(engine, socket, null, "Server");

        // read client application data
        receiveAppData(engine, socket, clientApp, "Server");

        // write server application data
        deliverAppData(engine, socket, serverApp, clientSocketAddr, "Server");
    }
    ...
    void doClientSide(DatagramSocket socket, InetSocketAddress serverSocketAddr)
        ...
        deliverAppData(engine, socket, clientApp, serverSocketAddr, "Client");

        // read server application data
        receiveAppData(engine, socket, serverApp, "Client");
    }
    ...
    // handshake
    SocketAddress handshake(SSLEngine engine, DatagramSocket socket,
                   SocketAddress serverAddr, String side) throws Exception {
    ...
    void receiveAppData(SSLEngine engine,
                        DatagramSocket socket, ByteBuffer expectedApp, String side) throws Exception {
    ...
    public final void runTest(DTLSOrg testCase) throws Exception {
    ...
    final static class ServerCallable implements Callable<String> {
        ...
        private final DTLSOrg testCase;
        private final DatagramSocket socket;
        private final InetSocketAddress clientSocketAddr;

        ServerCallable(DTLSOrg testCase, DatagramSocket socket,
    ...
    final static class ClientCallable implements Callable<String> {
        ...
        ClientCallable(DTLSOrg testCase, DatagramSocket socket,
